...
Subsequently, \ac{os} and \ac{us} are extensively compared in both feature and data space, revealing that \ac{nm2} outperform other methods achieving \ac{se} and \ac{sp} of 91.25\% and 81.67\%, respectively.
