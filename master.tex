...
\title{Study of Data Imbalancing for Melanoma Classification}
...
Subsequently, an extensive comparison between \ac{os} and \ac{us}, in both feature and data space is performed.
Our experiments reveal the fact that \ac{rus} and \ac{nm2} outperform other methods achieving \ac{se} and \ac{sp} of 92.50 \% and 78.33 \%, and 92.50 \% and 77.50 \%,  respectively.
