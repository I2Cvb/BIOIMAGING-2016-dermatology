...
Subsequently, \ac{os} and \ac{us} are extensively compared in both feature and data space, revealing that \ac{rus} and \ac{nm2} outperform other methods achieving \ac{se} and \ac{sp} of 92.50 \% and 78.33 \%, and 92.50 \% and 77.50 \%, respectively.
